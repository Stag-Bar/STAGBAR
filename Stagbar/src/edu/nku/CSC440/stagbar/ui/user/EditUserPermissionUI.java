...
public class EditUserPermissionUI {
    ...
    private void onOK() {
        for (UserListUI userRow : usersToBeModified) {
            if (userRow.getConversionStatus())
                userChanged = true;
        }
        /*if (userChanged.getPermissionLevel().equals(PermissionLevel.ADMIN))
            JOptionPane.showMessageDialog(contentPane, String.format(ADMIN_CONGRATS, userChanged.getUsername()), TITLE_PERMISSION_USER, JOptionPane.INFORMATION_MESSAGE);
        else if (userChanged.getPermissionLevel().equals(PermissionLevel.GUEST))
            JOptionPane.showMessageDialog(contentPane, String.format(GUEST_CONGRATS, userChanged.getUsername()), TITLE_PERMISSION_USER, JOptionPane.INFORMATION_MESSAGE);
        else*/
