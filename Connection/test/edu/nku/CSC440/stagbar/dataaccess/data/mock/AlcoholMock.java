...
public class AlcoholMock {
	...
	public static final Alcohol GROG = new Alcohol(15, "Grog", CustomAlcoholTypeMock.DRAFT_BEER, LocalDate.now().minus(2, ChronoUnit.YEARS), LocalDate.now().minus(1, ChronoUnit.YEARS));
	...
	public static final Alcohol SWILL = new Alcohol(16, "Swill", CustomAlcoholTypeMock.DRAFT_BEER, LocalDate.now().minus(2, ChronoUnit.YEARS), LocalDate.now().minus(1, ChronoUnit.YEARS));
